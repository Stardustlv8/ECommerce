    ...
    public class MailHelper
    {
        public static async Task SendMail(string to, string subject, string body)
        {
            ...
            message.From = new MailAddress(
                WebConfigurationManager.AppSettings["AdminUser"]);
            ...
            using (var smtp = new SmtpClient())
            {
                ...
                {
                    UserName = WebConfigurationManager
                    .AppSettings["AdminUser"],

                    Password = WebConfigurationManager
                    .AppSettings["AdminPassWord"]
                };

                smtp.Credentials = credential;

                smtp.Host = WebConfigurationManager
                    .AppSettings["SMTPName"];
